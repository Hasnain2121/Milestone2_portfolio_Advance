  ...
  return (
    <section className="py-12 px-6">
      ...
      <div className="text-center mb-12">
        <h2 className="text-orange-500 font-bold text-4xl sm:text-6xl lg:text-8xl my-16">Portfolio</h2>
        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-8">My Amazing Works</h3>
          ...
          <button
            ...
            className={`${
              activeFilter === filter
                ...
                : "text-gray-600"
            } px-3 py-2 sm:px-4 hover:text-orange-500 transition`}
      ...
      <section className="flex flex-col md:flex-row items-center justify-center py-12 px-6 bg-white">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          {/* Skill Bars */}
          <div className="mb-6">
            <p className="font-medium text-gray-800 mb-2">Full Stack</p>
